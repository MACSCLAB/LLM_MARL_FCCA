...
def get_config():
    ...
    # agent parameters
    parser.add_argument("--num_humans", type=int, default=5, help="number of dynamic obstacles")
    parser.add_argument("--num_attention_agents", type=int, default=5, help="number of agents that should be paid attention")
    parser.add_argument("--for_edge", type=int,default=1, help='the formation edge lenth')
    parser.add_argument("--robot_radius", type=float,default=0.3, help='the radius of robot')
    parser.add_argument("--human_radius", type=float,default=0.4, help='the radius of human')
    parser.add_argument("--dcf_dist",type=float,default=0.2,help='discomfort distance of robot and human')
    parser.add_argument("--base_v",type=float,default=0.1,help='When use discrete envirnment,the base velosity in action space')
    ...
    parser.add_argument("--v_pref",type=float,default=0.5,help='the preferred velocity of agents')
